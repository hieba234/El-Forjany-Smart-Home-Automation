  ...
  en: {
    ...
    data: {
      security: {
        ...
        estimate:'Custom quote after the free visit. Typical starter security setups begin from EGP 8,500 depending on devices and wiring.',
      ...
      lighting: {
        ...
        estimate:'Custom quote after the free visit. Starter lighting automation can begin from EGP 4,500 depending on room count.',
...
if(leadForm){
  ...
  leadForm.addEventListener('submit', function(e){
    ...
    // Google's date+time question actually expects, immediately before the native submit proceeds.
    ...
    // Submit the native form for real to the Google Form endpoint, then show the thank-you state.
    window.setTimeout(() => {
      leadForm.submit();
